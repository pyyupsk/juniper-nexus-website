        ...
        <main className="mt-16">
            ...
            <section className="py-16 container">
                <div className="rounded-lg border border-primary shadow-lg p-6 md:p-8 lg:p-16 relative">
                    ...
                    <p className="quote">
                        สมาชิกที่ละเมิดกฎหรือข้อกำหนดของกิลด์และเซิฟเวอร์จะได้รับการลงโทษตามบทลงโทษที่เหมาะสม เช่น
                        การเตือน การห้ามเข้าถึง และบางครั้งอาจมีการเตะออกจากเซิฟเวอร์
                    </p>
                </div>
            </section>
